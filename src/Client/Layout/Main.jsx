...
const Main = () => {
  ...
  const pathsToHideHeaderFooter = ['/loginPage',"/customerDataSohozDjr" ,"/CostDetailsSohozDjr" , "/ridersAcceptedOrdersSohozDjr", '/usersListSohozDjr', "/collectDataSohozDjr", "/completedRiderOrderSohozDjr", "/usersSohozDjr", '/registerPage', '/updateProfile', "/dashboardHomeSohozDjr", "/ridersOrderrdersSohozDjr" , "/userPlaceOrderSohozDjr"];
