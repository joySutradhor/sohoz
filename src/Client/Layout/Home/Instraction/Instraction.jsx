        ...
        <div>
            ...
            <div className="grid grid-cols-4 justify-evenly items-center px-2">
                <div className="flex flex-col justify-center items-center">
                    ...
                    <p className="font-poppins pt-2 text-gray-400  text-[10px]">Grocery</p>
                </div>
                <div className="flex flex-col justify-center items-center">
                    <div className=" font-poppins text-[8px] h-[49px] w-[65px] rounded-[10px]  bg-white flex justify-center items-center">
                    ...
                    <p className="font-poppins pt-2 text-gray-400  text-[10px]">Electronics</p>
                </div>
                <div className="flex flex-col justify-center items-center">
                    <div className=" font-poppins text-[8px] h-[49px] w-[65px] rounded-[10px]  bg-white flex justify-center items-center">
                    ...
                    <p className="font-poppins pt-2 text-gray-400  text-[10px]">Tools</p>
                </div>
                <div className="flex flex-col justify-center items-center">
                    <div className=" font-poppins text-[8px] h-[49px] w-[65px] rounded-[10px]  bg-white flex justify-center items-center">
                    ...
                    <p className="font-poppins pt-2 text-gray-400  text-[10px]">Baby Kids</p>
                </div>
            </div>
        </div>
