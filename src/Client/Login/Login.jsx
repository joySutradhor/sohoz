...
export default function Login() {
    ...
    return (
        <div className='flex  items-center h-screen justify-center '>
            <div className='bg-slate-50 shadow-md  pb-20 px-16 pt-10 mx-4'>
                <h1 className='pb-8 text-center text-2xl font-serif'>Login Now </h1>
                <Box sx={{ display: 'flex', flexWrap: 'wrap', }}>
                    ...
                    <div className='flex flex-col space-y-5'>
                        ...
                        {/* <div className='flex justify-center py-8'>
                            <Link className="relative inline-flex items-center justify-start px-6 py-3 overflow-hidden font-medium transition-all bg-slate-100 shadow-md  rounded hover:bg-white group">
