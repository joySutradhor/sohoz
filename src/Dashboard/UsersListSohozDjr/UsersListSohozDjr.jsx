...
export default function UsersListSohozDjr() {
    ...
    return (
        <React.Fragment>
            ...
            {/* <AppBar position="fixed" color="primary" sx={{ backgroundColor: "#fff", top: 'auto', bottom: 0 }}>
                <Toolbar>
                    <IconButton color="inherit" sx={{ color: "#4D88A8" }} aria-label="open drawer">
                        <HomeIcon />
                    </IconButton>

                    <Box sx={{ flexGrow: 1 }} />
                    <IconButton color="inherit" sx={{ color: "#4D88A8" }} >
                        <SearchIcon />
                    </IconButton>
